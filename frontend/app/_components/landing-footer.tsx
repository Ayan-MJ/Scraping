...
export function LandingFooter() {
  return (
    <footer className="border-t border-gray-800 bg-brand-dark py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm mb-4">
              The modern web scraping platform for businesses that need reliable data collection
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} ScrapeWizard. All rights reserved.
          </p>
